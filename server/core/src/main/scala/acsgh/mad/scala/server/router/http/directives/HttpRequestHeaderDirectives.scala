...
trait HttpRequestHeaderDirectives extends HttpDefaultParamHandling with HttpDefaultFormats {
  ...
  def requestHeader[P1, R1](param1: Param[P1, R1])(action: R1 => HttpResponse)(implicit context: HttpRequestContext): HttpResponse = {
    action(param1.headerValue)
  }

  def requestHeader[P1, R1, P2, R2](param1: Param[P1, R1], param2: Param[P2, R2])(action: (R1, R2) => HttpResponse)(implicit context: HttpRequestContext): HttpResponse = {
    action(param1.headerValue, param2.headerValue)
  }

  def requestHeader[P1, R1, P2, R2, P3, R3](param1: Param[P1, R1], param2: Param[P2, R2], param3: Param[P3, R3])(action: (R1, R2, R3) => HttpResponse)(implicit context: HttpRequestContext): HttpResponse = {
    action(param1.headerValue, param2.headerValue, param3.headerValue)
  }

  def requestHeader[P1, R1, P2, R2, P3, R3, P4, R4](param1: Param[P1, R1], param2: Param[P2, R2], param3: Param[P3, R3], param4: Param[P4, R4])(action: (R1, R2, R3, R4) => HttpResponse)(implicit context: HttpRequestContext): HttpResponse = {
    action(param1.headerValue, param2.headerValue, param3.headerValue, param4.headerValue)
  }

  def requestHeader[P1, R1, P2, R2, P3, R3, P4, R4, P5, R5](param1: Param[P1, R1], param2: Param[P2, R2], param3: Param[P3, R3], param4: Param[P4, R4], param5: Param[P5, R5])(action: (R1, R2, R3, R4, R5) => HttpResponse)(implicit context: HttpRequestContext): HttpResponse = {
    action(param1.headerValue, param2.headerValue, param3.headerValue, param4.headerValue, param5.headerValue)
  }

  def requestHeader[P1, R1, P2, R2, P3, R3, P4, R4, P5, R5, P6, R6](param1: Param[P1, R1], param2: Param[P2, R2], param3: Param[P3, R3], param4: Param[P4, R4], param5: Param[P5, R5], param6: Param[P6, R6])(action: (R1, R2, R3, R4, R5, R6) => HttpResponse)(implicit context: HttpRequestContext): HttpResponse = {
    action(param1.headerValue, param2.headerValue, param3.headerValue, param4.headerValue, param5.headerValue, param6.headerValue)
  }

  def requestHeader[P1, R1, P2, R2, P3, R3, P4, R4, P5, R5, P6, R6, P7, R7](param1: Param[P1, R1], param2: Param[P2, R2], param3: Param[P3, R3], param4: Param[P4, R4], param5: Param[P5, R5], param6: Param[P6, R6], param7: Param[P7, R7])(action: (R1, R2, R3, R4, R5, R6, R7) => HttpResponse)(implicit context: HttpRequestContext): HttpResponse = {
