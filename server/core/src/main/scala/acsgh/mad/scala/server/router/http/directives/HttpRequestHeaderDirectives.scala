...
trait HttpRequestHeaderDirectives extends HttpDefaultParamHandling with HttpDefaultFormats {
  ...
  def requestHeader[R, P1, R1](param1: Param[String, P1, R1])(action: R1 => R)(implicit context: HttpRequestContext): R = {
    action(param1.headerValue)
  }

  def requestHeader[R, P1, R1, P2, R2](param1: Param[String, P1, R1], param2: Param[String, P2, R2])(action: (R1, R2) => R)(implicit context: HttpRequestContext): R = {
    action(param1.headerValue, param2.headerValue)
  }

  def requestHeader[R, P1, R1, P2, R2, P3, R3](param1: Param[String, P1, R1], param2: Param[String, P2, R2], param3: Param[String, P3, R3])(action: (R1, R2, R3) => R)(implicit context: HttpRequestContext): R = {
    action(param1.headerValue, param2.headerValue, param3.headerValue)
  }

  def requestHeader[R, P1, R1, P2, R2, P3, R3, P4, R4](param1: Param[String, P1, R1], param2: Param[String, P2, R2], param3: Param[String, P3, R3], param4: Param[String, P4, R4])(action: (R1, R2, R3, R4) => R)(implicit context: HttpRequestContext): R = {
    action(param1.headerValue, param2.headerValue, param3.headerValue, param4.headerValue)
  }

  def requestHeader[R, P1, R1, P2, R2, P3, R3, P4, R4, P5, R5](param1: Param[String, P1, R1], param2: Param[String, P2, R2], param3: Param[String, P3, R3], param4: Param[String, P4, R4], param5: Param[String, P5, R5])(action: (R1, R2, R3, R4, R5) => R)(implicit context: HttpRequestContext): R = {
    action(param1.headerValue, param2.headerValue, param3.headerValue, param4.headerValue, param5.headerValue)
  }

  def requestHeader[R, P1, R1, P2, R2, P3, R3, P4, R4, P5, R5, P6, R6](param1: Param[String, P1, R1], param2: Param[String, P2, R2], param3: Param[String, P3, R3], param4: Param[String, P4, R4], param5: Param[String, P5, R5], param6: Param[String, P6, R6])(action: (R1, R2, R3, R4, R5, R6) => R)(implicit context: HttpRequestContext): R = {
